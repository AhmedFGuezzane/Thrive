...
import { useCustomTheme } from '../../hooks/useCustomeTheme'; // <-- CORRECTED TYPO HERE
import { createSeance } from '../../utils/seanceService.jsx'; // <-- NEW: Import the createSeance function
...
  // --- MODIFIED: The handleSubmit function now uses createSeance directly, mirroring UserHome.jsx ---
